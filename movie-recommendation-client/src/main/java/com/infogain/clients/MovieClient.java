...
import com.infogain.fallbacks.MovieClientHystrixFallback;
import com.infogain.request.CreateMovieRequest;

//@FeignClient(value = "movieclient", url = "http://localhost:9090/movie")
@FeignClient(name = "MOVIE-SERVICE", fallback = MovieClientHystrixFallback.class)
public interface MovieClient {
	...
	MovieDTO createMovie(@RequestBody @Valid CreateMovieRequest request);
	 ...
	 List<MovieDTO> getMoviesById(@RequestParam List<Long> ids);
	 
	 @GetMapping("/movie/dummyData")
